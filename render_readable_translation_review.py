...
metrics_path = base / 'contrastive_latent_faithfulness_v2_gpt55_low_full218/scorer/faithfulness_metrics.csv'
out_path = base / 'stable_core_latent_cards_translation_review/stable_core_latent_cards_每标签5个_中文审核易读版.md'
...
out = ['# Stable-core latent 中文审核易读版', '', '本文件按“待评估句子 → 模型生成的中文解释 → held-out 预测准确率”组织，供人工审核。每个标签抽取5个 latent。', '', '来源：已完成的 GPT-5.5-low 全量 card；本文件仅重新排版，不重新生成评估。指标来自 held-out scorer。', '']
