...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Filtered latent-label association matrix used as the minimal-subspace candidate source.",
    )
    parser.add_argument(
        "--thresholded-sets",
        default=None,
        help="Optional legacy candidate seed table. Must be omitted for filtered_topk_only.",
    )
    parser.add_argument(
        "--feature-store",
    ...
    parser.add_argument(
        "--output-dir",
        default="outputs/misc_full_sae_eval/interpretability/minimal_sufficient_subspace_v2_filtered",
    ...
    parser.add_argument(
        ...
        help="Feature filter audit used to assert all candidates are keep=True.",
    )
    parser.add_argument(
        "--candidate-policy",
        choices=["filtered_topk_only", "legacy_seed_plus_topk"],
        default="filtered_topk_only",
        help="How to build each label's candidate pool.",
    )
