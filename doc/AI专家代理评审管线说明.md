...
python run_ai_re_judge.py `
  --input-dir outputs/sae_eval_full_max `
  --output-dir outputs/sae_eval_full_max/ai_judge_dry `
...
python run_ai_re_judge.py `
  --input-dir outputs/sae_eval_full_max `
  --output-dir outputs/sae_eval_full_max/ai_judge
```
